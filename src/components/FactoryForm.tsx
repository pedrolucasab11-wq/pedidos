...
export const emptyFactoryForm: FactoryFormData = {
  cnpj: "",
  name: "",
  razaoSocial: "",
  inscricaoEstadual: "",
...
/**
 * Formulário completo de dados de fábrica (dados, contato, endereço, atividade
 * econômica), com autopreenchimento via CNPJ. Reutilizado no cadastro e na edição.
 */
const FactoryForm: React.FC<FactoryFormProps> = ({
  ...
  const [form, setForm] = useState<FactoryFormData>(initialData);
    ...
    <form onSubmit={handleSubmit} className="card">
      ...
      <div className="modal-footer" style={{ padding: "1.5rem 0 0", borderTop: "2px solid #e8edf2" }}>
        ...
        <button type="submit" className="btn btn-success" disabled={submitting}>
          {submitting ? "Salvando..." : (<><FaCheck /> {submitLabel}</>)}
        </button>
      </div>
    </form>
  );
